...
class LaporanController extends Controller
{
    ...
    public function getdatalaporan(Request $request){
        ...
        if($inputlaporan['jenislaporan'] == "Keluar masuk barang"){
            return response()->json(['stats'=>300, 'laporanbarang'=> $LaporanBarang , 'jenislaporan'=> $inputlaporan['jenislaporan'] , 'periodeawal'=>$tanggalawalLaporan, 'periodeakhir'=>$tanggalakhirLaporan]);
        }
