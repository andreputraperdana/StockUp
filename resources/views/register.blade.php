            ...
            <form action="/daftar" method="POST" enctype="multipart/form-data" id="submitform">
                ...
                <div class="daftar_header">
                    ...
                    <div class="menu_daftar">
                        <div class="pe-5">
                            <button type="button" name="UMKM" value="1" class="btn btnUmkm" id="btnUmkm"
                                style="background-color: #d7caa0;">UMKM</button>
                        </div>
                        <div class="">
                            <button type="button" name="UMKM" value="2" class="btn btnUmkm"
                                id="btnPemasok">Pemasok</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="daftar_profil_isi d-flex pt-4">
                            <div class="daftar_profil_kiri me-5 mt-2" style="width: 25%;">
                                <div class="daftar_profil_kiri_nama mb-3">
                                    <label for="exampleInputNama1" class="form-label"
                                ...
                                <div class="daftar_profil_kiri_kategori mt-4">
                                    <label for="exampleInputKategori1" class="form-label"
                                        style="color: black">Kategori</label>
                                </div>
                                ...
                                <div class="daftar_profil_kiri_nomortelepon mt-4">
                                    <label for="exampleInputNomorTelepon1" class="form-label"
                                        style="color: black">Nomor Telepon</label>
                                </div>
                                <div class="error-nomortelepon" style="display: none; visibility: collapse;">
                                    <p>test</p>
                                </div>
                                <div class="daftar_profil_kiri_foto mt-4">
                                    <label for="exampleInputFoto1" class="form-label"
                                        style="color: black">Foto</label>
                                </div>
                            ...
                            <div class="daftar_profil_kanan" style="width: 55%">
                                <div class="daftar_profil_kanan_nama mb-3">
                                    <input type="text" name="nama" class="form-control nama"
                                        id="exampleInputNama1" aria-describedby="emailHelp" placeholder="Nama"
                                        style="border: 1px solid #626262; background-color:transparent;">
                                </div>
                                ...
                                <div class="daftar_profil_kanan_nomortelepon mb-3">
                                    <input type="text" name="nomortelepon" class="form-control nomortelp"
                                        id="exampleInputNomorTelepon1" placeholder="Nomor Telepon"
                                        style="border: 1px solid #626262; background-color:transparent;">
                                </div>
                                ...
                                <div class="input_fotoprofil">
                                    <input type="file" name="fotoprofil" class="form-control fotoprofil"
                                        id="exampleInputFotoProfil1" aria-describedby="emailHelp"
                ...
                <div class="button_simpan d-flex justify-content-center pt-4">
                    <button type="submit" class="btn btn-primary ps-5 pe-5" id="btn_simpan"
                        style="background-color: #d7caa0; border: none; font-weight: bold; color: black;"
