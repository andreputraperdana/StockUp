        ...
        <div class="d-flex">
            ...
            <div class="center">
                ...
                <!-- <form action="{{route('barang.destroy', $hasil->id)}}" method="POST">
                    ...
                    <button class="btn__delete me-3 p-2 pe-3 ps-3" style="font-size: 16px; font-weight: bold;"><img src="{{URL::asset('trash.png')}}" alt="" onclick="deleteConfirmation( '{{ $hasil->id }}');" style="height: 25px;"></button>   
                <!-- </form> -->
