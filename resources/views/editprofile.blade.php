                ...
                @endif
                    <div class="daftar_header pt-5 pb-1">
                        ...
                        <div class="button__third">
                            <div class="d-flex align-items-center flex-column">
                                <button class="btn btn3" id="btnPemasok" style="border-radius: 50%; font-size: 20"><p class="ps-1 pt-3">3</p></button>
                                    ...
                                    <div class="daftar_akun ms-5" style="width: 95%;">
                                        ...
                                        <div class="pengaturan_akun_isi d-flex">
                                            <div class="pengaturan_platform_kiri mt-2" style="width: 35%; display: none;">
                                                <div class="pengaturan_akun_kiri_email mb-3">
                                                    <label for="exampleInputEmail1" class="form-label" style="color: black; font-size: 16px; font-weight: bold;">Instagram</label>
                                                </div>
                                                <div class="daftar_akun_kiri_password mt-4">
                                                    <label for="exampleInputPassword1" class="form-label" style="color: black; font-size: 16px; font-weight: bold;">Shopee</label>
                                                </div>
                                                <div class="daftar_akun_kiri_password mt-4" style="padding-top: 5px;">
                                                    <label for="exampleInputPassword1" class="form-label" style="color: black; font-size: 16px; font-weight: bold;">Tokopedia</label>
                                                </div>
                                            </div>
