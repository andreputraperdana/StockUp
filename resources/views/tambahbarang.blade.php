                            ...
                            <div style="width: 80%;">
                                ...
                                <div class="input_content_tanggalkadaluarsa mt-3">
                                    ...
                                    <div class="input_tanggalkadaluarsa">
                                        <input type="date" class="form-control tanggalkadaluarsa"
                                            name="tanggalkadaluarsa" id="exampleInputTanggalKadaluarsa1"
                                            aria-describedby="emailHelp" placeholder="Tanggal Kadaluarsa"
                                            style="border: 1px solid #626262; background-color:transparent;">
                                    </div>
                                </div>
