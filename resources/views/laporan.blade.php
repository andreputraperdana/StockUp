...
@section('content')
    ...
    <div class="content_tambahbarang mt-5"
        style="height: 780px; width: 100%; background-color: #F4F4F4; border-radius: 25px;">
            ...
            <div class="laporan d-flex justify-content-between" style="width: 90%;">
                    ...
                    <form action="/laporanbarang" method="POST">
                        ...
                        <div class="input_content_jenislaporan mt-3">
                            ...
                            <div class="daftar_profil_kanan_kategori mb-3">
                                <select name="jenislaporan" class="jenislaporan p-2"
                        ...
                        <div class="input_content_tanggalkadaluarsa mt-3">
                            ...
                            <div class="input_tanggal">
                                <input type="date" name="input_tanggalawal" class="form-control input_tanggalawal"
                                    id="input_tanggalawal" style="border: 1px solid #626262; background-color:transparent;">
                            </div>
                        </div>
                        ...
                        <div class="input_judul_tanggalakhir mt-3">
                            ...
                            <div class="input_tanggal">
                                <input type="date" name="input_tanggalakhir" class="form-control input_tanggalakhir"
                                    id="input_tanggalakhir"
                        ...
                        <div class="button_simpan d-flex justify-content-center pt-4 mt-2">
                            <button type="submit" class="btn btn-primary btn_preview ps-5 pe-5 " id="btn_preview"
                                style="background-color: #D7CAA0; width: 40%; font-weight: bold; color: black; border-radius: 7px;">Preview</button>
                        </div>
                    </form>
                </div>
                <div class="content_right_laporan" style="width: 45%;">
                                ...
                                <table class="table table-bordered" style="width: 90%; font-size: 7pt;">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col" style="opacity: 0.6; font-weight: bold;">Tanggal Masuk
                                                Barang</td>
                                            <td scope="col" style="opacity: 0.6; font-weight: bold;"
                                                class="text-center">Nama Barang</td>
                                            <td scope="col" style="opacity: 0.6; font-weight: bold;"
                                                class="text-center">Tanggal Kadaluarsa</td>
                                            <td scope="col" style="opacity: 0.6; font-weight: bold;"
                                ...
                                <table class="table table-bordered" style="width: 90%; font-size: 5pt;">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col" style="opacity: 0.6; font-weight: bold;"
                                                class="text-center">Tanggal Keluar</td>
                                        </tr>
                                    </thead>
                    ...
                    <div class="button_simpan d-flex justify-content-center pt-4 mt-2" style="width: 90%;">
                        <button type="submit" class="btn btn-primary ps-5 pe-5 " id="btn_download"
                            style="background-color: #D7CAA0; width: 60%; border: 2px solid #D7CAA0; font-weight: bold; color: black; border-radius: 7px;">
                            <img src="{{ URL::asset('downloadicon.png') }}" alt="" height="25px">Download
                            PDF</button>
                    </div>
                </div>
            </div>
