    ...
    <div class="" id="header">
        <div class="d-flex justify-content-end pt-4 pe-3">
            <div class="login pt-2">
                <button class="btn__login me-3 p-2 pe-3 ps-3" style="font-size: 16px; font-weight: bold;"> <a
                        href="/login">Masuk</a></button>
            </div>
            <div class="register pt-2">
                <button class="btn__register p-2 pe-3 ps-3" style="font-size: 16px; font-weight: bold;"><a
        ...
        <div class="content-header d-flex justify-content-evenly ps-5 mt-4" style="width: 100%;">
            <div class="d-flex justify-content-center" style="width: 90%;">
                <div class="contents pt-5" style="width: 42%;">
                    ...
                    <a href="#section1">
                        <button class="btn--text p-2 pe-3 ps-3"
                            style="color: black; font-size: 16px; font-weight: bold;">Pelajari &DownArrow;</button>
                    </a>
                </div>
