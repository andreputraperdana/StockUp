    ...
    @if(auth()->user()->roleid == 1)
        <div class="side_bar active">
            ...
            <ul class="menu_bar" id="menu_bar" style="width: 100%;">
                <li class="beranda_">
                    <a href="/beranda" class="linkBeranda">
                        <div class="menu_brnd d-flex ps-4" role="button">
                            <div class="iconmenu">
                ...
                <li class="tambahbarang_">
                    <a href="/tambahbarang" class="linkTambahBarang">
                        <div class="menu_tmbhbrg d-flex ps-4" style="width: 100%;" role="button">
                            <div class="iconmenu">
                ...
                <li class="laporan_">
                    <a href="/laporan" class="linkLaporan">
                        <div class="menu_lprn d-flex ps-4" role="button">
                            <div class="iconmenu">
                ...
                <li class="mengelolabarang_">
                    <a href="/mengelolabarang" class="linkMengelolaBarang">
                        <div class="menu_mnglola d-flex ps-4" role="button">
                            <div class="iconmenu">
                ...
                <li class="toko_">
                    <a href="/toko" class="linkToko">
                        <div class="menu_tko d-flex ps-4" role="button">
                            <div class="iconmenu">
