...
@section('content')
        ...
        <div class="atas_kanan d-flex  mt-5">
            ...
            <div class="dropdown mt-2">
                <button class="dropbutton ps-3 pe-4 pt-1 pb-1" style="border: none; border-radius: 25px;">
                    <img src="{{ URL::asset('akun.png') }}" alt="" style="height: 40px;">
    ...
    <div class="d-flex justify-content-center">
        <div class="content_tambahbarang mt-5 d-flex"
            style="height: 500px; width: 85%; background-color: #F4F4F4; border-radius: 25px;">
            <div class="chat pe-4 ps-4"
                style="width: 30%; height: 100%; border-radius: 25px 0 0 25px; border-right: 1px solid black;">
                ...
                <button class="content__chat d-flex" style="border: 0px; background-color: transparent;">
                    ...
                    <div class="pt-1 pe-3">
                        <p style="font-size: 16px; font-weight: bold; margin-bottom: -1px; margin-left: -16px;">Stefanie Lim
                        </p>
            ...
            <div style="width: 70%;">
                <div class="d-flex justify-content-center"
                    style="width: 100%; border-radius: 0 25px 0 0; background-color: #D7CAA0; height: 55px;">
                ...
                <div class="d-flex flex-column justify-content-end" style="height: 85%;">
                    <div class="d-flex justify-content-center">
                        <div class="d-flex"
                            style="border: 0; background-color:transparent; border-radius: 7px; width: 85%; height: 40px;">
                            <input type="text" class="form-control me-2" id="exampleInputTanggalKadaluarsa1"
                                aria-describedby="emailHelp" placeholder="Kirim Pesan"
                                style="border-radius: 0; background-color:transparent; border: 1px solid black;">
                            <button type="submit" class="btn"
                                style="border: 1px solid black; border-radius: 0 7px 7px 0; background-color: #D7CAA0;">
